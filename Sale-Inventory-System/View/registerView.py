...
class RegisterPage:
    def _register_page(self):
            ...
            self._create_entry_box_using_grid(frame=entryFrame,labels=self.register_labels_with_colspan,entryList=self.register_entry_boxes,max_columns=2,entryWidth=54)
